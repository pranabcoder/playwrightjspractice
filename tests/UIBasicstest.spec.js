...
test('Example - Child Window Handling', async ({ browser }) => {
  ...
  const domaniName = text.split('@')[1].split('.')[0];
  console.log(domaniName);
  await usernamePath.fill(domaniName);
  console.log(await usernamePath.textContent());
});
